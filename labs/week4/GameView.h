...
// This is just temp funcs to help me test something - Sam
int testRoadOnlyShortestPath(GameView g, LocationID s, LocationID f, LocationID path[] );
void setRound( GameView g, int r );
////////////////////////////////////////////////////////////////
#endif
